...
public interface ConsultaRepository extends JpaRepository<Consulta, Long> {
    ...
    /**
     * Método que retorna uma consulta do paciente na data especificada.
     * @param pacienteId
     ...
     */
    @Query(value = "SELECT * FROM consultas c WHERE c.paciente_id = :pacienteId AND DATE(c.data_consulta) = :dataConsulta LIMIT 1", nativeQuery = true)
    Optional<Consulta> findOneConsultaByPacienteIdAndDataConsulta(@Param("pacienteId") Long pacienteId, @Param("dataConsulta") LocalDate dataConsulta);
}
